...
void PointLight::parseOBJFile(std::string objFilename)
{
...
void PointLight::parseOBJFile2(std::string objFilename)
{
...
void PointLight::updatePointSize(GLfloat size)
{
	/*
...
void PointLight::spin(float deg, glm::vec3 rotationAxis)
{
...
void PointLight::rotate(float deg, glm::vec3 rotationAxis)
{
	...
	lightPosition =  glm::rotate(glm::mat4(1.0f), glm::radians(deg), rotationAxis) * glm::vec4(lightPosition, 1.0f);
}

void PointLight::rotateModel(float deg, glm::vec3 rotationAxis)
{
...
void PointLight::resetOrientation()
{
...
void PointLight::translate(glm::vec3 translation)
{
	...
	lightPosition = lightPosition + translation;
}
...
void PointLight::scale(float scaleFactor)
{
	model = glm::scale(model, glm::vec3(scaleFactor));
	scaleMat = glm::scale(scaleMat, glm::vec3(scaleFactor));
}

void PointLight::resetScale()
{
...
std::vector<glm::vec3> PointLight::getPoints()
{
	return points;
}

std::vector<glm::vec3> PointLight::getNormals()
{
	return normals;
}

GLfloat PointLight::getPointSize()
{
	return pointSize;
}
